...
import cv2
import numpy as np
import picture_recognition.文字识别 as 文字识别
import re 
...
def detect(zip_image,img):
    ...
    # 5.文字识别
    answers=文字识别.result(zip_image,new_region)
...
if __name__ == '__main__':
    # imagePath = './img_rec/red1.png'  #红色
    # imagePath = './img_rec/red2.png'  #红色
    # imagePath = './img_rec/red3.png'  #红色
    # imagePath='./img_rec/1.jpg' #红色

    imagePath='./red/1.jpg' #红色
    red(imagePath)

    # imagePath='./img_rec_black/1.png' #黑色
    # imagePath='./test/test.jpg' #黑色
    # imagePath='./test/4.jpg' #黑色
    # imagePath='./test/8.jpg' #黑色
    # black(imagePath)
